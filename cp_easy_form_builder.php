...
$codepeople_promote_banner_plugins[ 'cp-easy-form-builder' ] = array( 'plugin_name' => 'CP Easy Form Builder (Form Builder CP)', 'plugin_url'  => 'https://wordpress.org/support/plugin/cp-easy-form-builder/reviews/#new-post');
...
function cp_easyform_helpLink($links) {
    $help_link = '<a href="http://wordpress.dwbooster.com/forms/cp-easy-form-builder">'.__('Documentation').'</a>';
